#!/bin/bash
# System2 training (32B) — Kubernetes-compatible
# Diff from base.sh: llm=32B, zero3, batch_size=1, grad_accum_steps=16
...
# Model configuration
llm=$HOME/data-vol2/checkpoints/Qwen/Qwen2.5-VL-32B-Instruct
...
run_name=s2_backbone/32b_$(date +%Y%m%d_%H%M%S)
