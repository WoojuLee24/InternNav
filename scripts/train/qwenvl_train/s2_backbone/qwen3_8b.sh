#!/bin/bash
# System2 training (Qwen3-VL-8B) — Kubernetes-compatible
# Diff from base.sh: llm=Qwen3-VL-8B-Instruct
#
...
# Model configuration
llm=$HOME/data-vol2/checkpoints/Qwen/Qwen3-VL-8B-Instruct

# Training hyperparameters
# 1node x 8GPU x bs4 x accum4 = 128 effective batch
lr=2e-5
...
run_name=s2_backbone/qwen3_8b_$(date +%Y%m%d_%H%M%S)
