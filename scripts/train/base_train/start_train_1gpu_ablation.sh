#!/bin/bash
# ============================================================
#  Ablation training script — flexible grid search
#  Usage:  bash start_train_ablation.sh
#
...
# ---- BASE CONFIG -------------------------------------------
MODEL=navdp_1gpu          # base config: navdp_1gpu or navdp_1node
...
SCENE_SCALE_LIST=(0.005)    # e.g. (0.01 0.1 1.0)
