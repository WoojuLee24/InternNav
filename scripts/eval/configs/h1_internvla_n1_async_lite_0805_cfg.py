...
eval_cfg = EvalCfg(
    agent=AgentCfg(
        ...
        model_settings={
            'env_num': 1,
            'sim_num': 1,
            'model_path': "checkpoints/InternVLA-N1-DualVLN-lite",
'mode': 'system2',
            ...
            'vis_debug_path': '/media/T7/InternNav_eval/test_n1_lite_0805/vis_debug',
        },
    ),
    env=EnvCfg(
    ...
    task=TaskCfg(
        ...
        flash_collision="stop",  # If flash_collision is True, the robot will stop when collision detected.
