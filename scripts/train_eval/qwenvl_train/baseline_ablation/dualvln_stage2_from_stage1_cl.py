"""`baseline/dualvln_stage2_from_stage1.py` + patch_embed을 channels_last_3d 입력으로 (cuDNN 경로) (`patch_embed_impl="channels_last"`).
...
EXP_NAME = "baseline_ablation/dualvln_stage2_from_stage1_cl"
