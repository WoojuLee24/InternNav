#!/usr/bin/env python3
"""Parse Gate 3k results and print paper-ready table rows."""
import json, math, os
...
print("=== Gate 3k: EMA Fingerprint α Sweep ===\n")

# Baseline row
print("--- BASELINE (EMA=off) ---")
for b in BAGS:
    ...
    if os.path.exists(path):
        ...
        print(f"  bag={b}: skip={skip:.1f}%  bg={bg}  AA={aa}  MH={mh}  ar={ar:.1f}%")
    else:
